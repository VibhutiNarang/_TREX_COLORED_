 ...
 if (frameCount % 60 === 0){
   ...
   obstacle.velocityX = -(6 + score/100);
    ...
    switch(rand) {
      ...
      obstacle.scale = 0.35;obstacle.setCollider("rectangle",0,0,obstacle.width/2,obstacle.height/2);
              break;
  ...
  obstacle.setCollider("rectangle",0,0,obstacle.width/2,obstacle.height/2);
      ...
      obstacle.scale = 0.15;  obstacle.setCollider("rectangle",0,0,obstacle.width/2,obstacle.height/2);
              break;
